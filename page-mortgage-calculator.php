...
<div class="col-12">
  ...
  <div class="row justify-content-center mt-3 mt-md-5">
    <div class="col-12 col-sm-8 col-md-8 col-lg-6 col-xl-6 col-xxl-6 scene">
      <div class="flip-card">
        <div class="card__face card__face--front calculator-container p-4 p-lg-5" data-calculation="mortgage">
          ...
          <div class="currency-input-container empty">
            <input class="calculator-input" inputmode=“numeric” type="tel" name="income" id="income" placeholder="0" required min="1" />
          </div>
          ...
          ></label>
          <div class="currency-input-container empty">
            <input class="calculator-input "" inputmode=“numeric” type="tel" name="otherIncome" id="otherIncome" placeholder="0" min="0"
            />
          </div>

          <label class="label-text ml-0">Deposit Amount<span class="error" id="errordeposit"></span></label>
          <div class="currency-input-container empty">
            <input class="calculator-input"" inputmode=“numeric” type="tel" name="deposit" id="deposit" placeholder="0" required
            min="1"/>
          </div>
