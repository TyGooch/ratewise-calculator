...
<div class="col-12">
  ...
  <div class="row justify-content-center mt-3 mt-md-5">
    <div class="col-12 col-sm-8 col-md-8 col-lg-6 col-xl-6 col-xxl-6 scene">
      <div class="flip-card">
        <div class="card__face card__face--front calculator-container p-4 p-lg-5" data-calculation="car">
        <label class="label-text ml-0">Car Loan Amount<span class="error" id="erroramount"></span></label>
        ...
        <p class="mb-0 result-subheader">Car financing of <b class="purple" id="totalAmount"></b> could cost</p>
                  ...
                  <button
                    ...
                    class="app-btn mb-4"
                    id="getQuoteButton"
                    data-url="https://ratewise.co.uk/car-loan/car-type/"
                  >
                    Apply Now
                  </button>
