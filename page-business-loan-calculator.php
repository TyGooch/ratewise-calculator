...
<div class="col-12">
  ...
  <div class="row justify-content-center mt-3 mt-md-5">
    <div class="col-12 col-sm-8 col-md-8 col-lg-6 col-xl-6 col-xxl-6 scene">
      <div class="flip-card">
        <div class="card__face card__face--front calculator-container p-4 p-lg-5" data-calculation="business">
        <label class="label-text ml-0">Business Loan Amount<span class="error" id="erroramount"></span></label>
                  ...
                  <label class="label-text ml-0">Interest Rate<span class="error" id="errorinterest"></span></label>
                  <input
                    class="calculator-input mb-4"
                    type="number"
                    name="interest"
                    id="interest"
                    placeholder="6.9"
        ...
        <p class="mb-0 result-subheader">Business financing of <b class="purple" id="totalAmount"></b> could cost</p>
                  ...
                  <button
                    ...
                    class="app-btn mb-4"
                    id="getQuoteButton"
                    data-url="https://ratewise.co.uk/business-loan/business-purpose/"
                  >
                    Apply Now
                  </button>
